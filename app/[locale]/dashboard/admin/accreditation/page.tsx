...
export default function AccreditationPage() {
  ...
  const handleSearch = async () => {
    ...
    setSearching(true)
    try {
      // Basic search: fetch all users and filter locally (consistent with AdminManagementTables)
      // For scale, we could use specific queries, but let's stick to the current project pattern for now
